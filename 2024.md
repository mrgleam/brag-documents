...
**Contributions:** [Fix unable compatible with new version of gleamlang](https://github.com/lpil/zeptomail/pull/1)
  
**Scope:** Package
  
**Impact:** package is compatible with new version of gleamlang.

**Contributions:** [Update function "at" in stdlib of list deprecated](https://github.com/mrdimosthenis/minigen/pull/4)
  
**Scope:** Package
  
**Impact:** package is compatible with new version of gleamlang.

**Contributions:** [fix(validate-email): email could contain multiple char in prefix/suffix](https://github.com/sporto/gleam-valid/pull/4)
  
**Scope:** Package
  
**Impact:** fix invalid email pattern.
